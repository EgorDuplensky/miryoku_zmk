...
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    &kp F,             &kp G,             &kp H,             &kp J,             U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SEMI),   \
...
&kp LSHFT  K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &kp RSHFT \
